...
function chatAnswer(text,cb){
  ...
  var bye=(function(t){
    ...
    if(/(^|[\s,.;!-])(пока|покеда|бывай|прощай|до свидания|до завтра|до встречи|доброй ночи|спокойной ночи|хватит|достаточно|закончим|заканчиваем|закончили|конец|отбой|отстань|надоел|надоело|устал от|я пошел|пошел я|ушел|отдыхай)([\s,.!…]|$)/.test(t))return true;
