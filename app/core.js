...
function chatAnswer(text,cb){
  ...
  if(bye){
    phase='ФАЗА «ПРОЩАНИЕ»: человек явно завершает разговор. Тепло попрощайся ОДНОЙ-ДВУМЯ строками, '+
      'без новых советов, без вопросов и без нравоучений. Если по ходу разговора было задание — напомни его одной короткой фразой. '+
      'Закончи приглашением заглянуть завтра. Максимум 2 строки.';}
  else if(offtop){
